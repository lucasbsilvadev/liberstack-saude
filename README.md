...
[![Docker](https://img.shields.io/badge/Docker-2.3%25-blue)](https://www.docker.com/)
...
```bash
git clone https://github.com/lucasbsilvadev/liberstack-saude.git
cd liberstack-saude
```
...
```bash
docker build -t liberstack-saude .
```
